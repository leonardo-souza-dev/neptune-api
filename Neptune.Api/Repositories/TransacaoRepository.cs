...
namespace Neptune.Api.Services
{
    public class TransacaoRepository : ITransacaoRepository
    {
        ...
        public TransacaoRepository()
        {
            ...
            _transacoes.Add(new Transacao(1, DateTime.Now.AddMonths(-1), "Rendimento", 10M, 2));
            //_transacoes.Add(new Transacao(2, DateTime.Now.AddDays(-7), "Café", 4M, 1));
            _transacoes.Add(new Transacao(3, DateTime.Now, "Café", 2M, 1));
            _transacoes.Add(new Transacao(3, DateTime.Now, "Rendimento", 2M, 2));
